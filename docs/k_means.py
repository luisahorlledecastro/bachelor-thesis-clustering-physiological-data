...
class KM:
    ...
    def elbow_method(self, data, k_max):
        ...
        """
        data = scr.df_single_between_no_var.T
    ...
    def kmeans_cluster(self, data, k):
        ...
        for cluster_label in range(k):
            ...
            self.cluster_dfs.append(self.cluster_df.T)
    ...
    def show_cluster_heatmaps(self, data, k=None, target=None):
        ...
        :return:
        """
        self.scr_with_cluster = deepcopy(scr.df_between)
        ...
        if target != "cluster":
            ...
            for i, cluster in enumerate(self.cluster_dfs):
                ...
                print(self.scr_with_cluster)
                # Filter self.scr_with_cluster to include only columns present in the cluster
                cluster_data = self.scr_with_cluster.T[cluster_cols]
    ...
    def show_mean_heatmap(self, data):
        ...
        heatmap_data_average = (scr.data_mean_between.pivot_table(index='var1', columns='var2', values='mean_all'))
...
if __name__ == '__main__':
    scr = SCR()
    scr.prep_scr()
    data = scr.df_single_between_no_var
    km = KM()
